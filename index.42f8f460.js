 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z=function(e){let t={},n={},i={},r="";try{const o=e.split(".");t=F(I(o[0])||""),n=F(I(o[1])||""),r=o[2],i=n.d||{},delete n.d}catch(e){}return{header:t,claims:n,data:i,signature:r}},j=function(e){const t=z(e).claims;return!!t&&"object"==typeof t&&t.hasOwnProperty("iat")},H=function(e){const t=z(e).claims;return"object"==typeof t&&!0===t.admin};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Uo=new class extends co{compare(e,t){const n=e.node.compareTo(t.node);return 0===n?fr(e.name,t.name):n}isDefinedOn(e){return!0}indexedValueChanged(e,t){return!e.equals(t)}minPost(){return lo.MIN}maxPost(){return lo.MAX}makePost(e,t){const n=Lo(e);return new lo(t,n)}toString(){return".value"}},Fo="-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",Wo=function(){let e=0;const t=[];return function(n){const i=n===e;let r;e=n;const o=new Array(8);for(r=7;r>=0;r--)o[r]=Fo.charAt(n%64),n=Math.floor(n/64);b(0===n,"Cannot push at time == 0");let s=o.join("");if(i){for(r=11;r>=0&&63===t[r];r--)t[r]=0;t[r]++}else for(r=0;r<12;r++)t[r]=Math.floor(64*Math.random());for(r=0;r<12;r++)s+=Fo.charAt(t[r]);return b(20===s.length,"nextPushId: Length should be 20."),s}}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();qe(Hi);const Nl=function(e=Ve(),t){return je(e,"database").getImmediate({identifier:t})}();let Il=null,Tl=null;function Sl(e){Il=e}function El(e){Tl=e}function Rl(e){return console.log(e.id),null!==e.id||(t(Vi).Notify.info("Please sign in to your account or register"),!1)}function Ol(e){return!e.currentTarget.hasAttribute("disable")||(t(Vi).Notify.info("<Title> is already in list Watched"),!1)}function Ml(e,t){return{movie:e,id:t}}function Al(e){vl(yl(Nl,"movies/watched/"),e)}function Dl(e){vl(yl(Nl,"movies/queue/"),e)}qe(Hi);const Pl=
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
function(e=Ve()){const t=je(e,"auth");return t.isInitialized()?t.getImmediate():function(e,t){const n=je(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(G(n.getOptions(),null!=t?t:{}))return e;ct(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Wi,persistence:[ti,zn,Hn]})}(),Ll=new Cn;function Bl(e,t){Ln(Pl,e,t).then((e=>{const t=e.user;console.log(t)})).catch((e=>{e.code,e.message}))}function Ul(e,t){Bn(Pl,e,t).then((e=>{console.log(t);const t=e.user;f.signOutBtn.addEventListener("click",jl),f.signOutWrap.classList.remove("is-hidden")})).catch((e=>{e.code,e.message}))}var Fl,Wl,zl;function jl(e){Un(Pl).then((()=>{f.signOutWrap.classList.add("is-hidden"),f.signOutBtn.removeEventListener("click",jl)})).catch((e=>{}))}Fl=e=>{if(e){const t=e.uid;Sl(t),f.signOutBtn.addEventListener("click",jl),f.signOutWrap.classList.remove("is-hidden"),console.log(t),console.log(e)}else console.log(null),Sl(null)},se(Pl).onAuthStateChanged(Fl,Wl,zl);let Hl="registration";function Yl(){Hl="registration"===Hl?"authorization":"registration";const e="registration"===Hl?"Registration":"Sign In",t="registration"===Hl?"Sign In":"Registration",n="registration"===Hl?"Register now":"Sign In";f.formSwitchBtn.textContent=t,f.formSubmitBtn.textContent=n,f.formTitle.textContent=e,f.form.reset()}function ql(e,t,n){f.buttonPopular.disabled=e,f.buttonTopRated.disabled=t,f.buttonNowPlaying.disabled=n}var Vl={};function $l(e){const t=e[0],{original_title:n,title:i,vote_average:r,vote_count:o,poster_path:s,overview:a,popularity:l,allGenres:c}=t,u=`<img src="https://image.tmdb.org/t/p/original${s}" alt="poster ${i}" class="modal-film__img">`,h=`\n            <h2 class="modal-film__name">${i}</h2>\n            <div class="modal-film__rating">\n                <div class="modal-film__list-name">\n                    <p class="modal-film__item-name">Vote / Votes</p>\n                    <p class="modal-film__item-name">Popularity</p>\n                    <p class="modal-film__item-name">Original Title</p>\n                    <p class="modal-film__item-name">Genre</p>\n                </div>\n                <div class="modal-film__list-description">\n                    <p class="modal-film__item-description"><span class="modal-film--style">${r}</span> / ${o}</p>\n                    <p class="modal-film__item-description">${l}</p>\n                    <p class="modal-film__item-description">${n}</p>\n                    <p class="modal-film__item-description">${c}</p >\n                </div>\n            </div>\n            <h3 class="modal-film__title">ABOUT</h3>\n            <p class="modal-film__description">${a}</p>\n       `,d=f.modalFilmHtml;f.modalFilmImg.innerHTML=u,d.innerHTML=h}Vl=function e(t,n,i){function r(s,a){if(!n[s]){if(!t[s]){var l=void 0;if(!a&&l)return l(s,!0);if(o)return o(s,!0);var c=new Error("Cannot find module '"+s+"'");throw c.code="MODULE_NOT_FOUND",c}var u=n[s]={exports:{}};t[s][0].call(u.exports,(function(e){return r(t[s][1][e]||e)}),u,u.exports,e,t,n,i)}return n[s].exports}for(var o=void 0,s=0;s<i.length;s++)r(i[s]);return r}({1:[function(e,t,n){Object.defineProperty(n,"__esModule",{value:!0}),n.create=n.visible=void 0;var i=function(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=document.createElement("div");return n.innerHTML=e.trim(),!0===t?n.children:n.firstChild},r=function(e,t){var n=e.children;return 1===n.length&&n[0].tagName===t},o=function(e){return null!=(e=e||document.querySelector(".basicLightbox"))&&!0===e.ownerDocument.body.contains(e)};n.visible=o,n.create=function(e,t){var n=function(e,t){var n=i('\n\t\t<div class="basicLightbox '.concat(t.className,'">\n\t\t\t<div class="basicLightbox__placeholder" role="dialog"></div>\n\t\t</div>\n\t')),o=n.querySelector(".basicLightbox__placeholder");e.forEach((function(e){return o.appendChild(e)}));var s=r(o,"IMG"),a=r(o,"VIDEO"),l=r(o,"IFRAME");return!0===s&&n.classList.add("basicLightbox--img"),!0===a&&n.classList.add("basicLightbox--video"),!0===l&&n.classList.add("basicLightbox--iframe"),n}(e=function(e){var t="string"==typeof e,n=e instanceof HTMLElement==1;if(!1===t&&!1===n)throw new Error("Content must be a DOM element/node or string");return!0===t?Array.from(i(e,!0)):"TEMPLATE"===e.tagName?[e.content.cloneNode(!0)]:Array.from(e.children)}(e),t=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};if(null==(e=Object.assign({},e)).closable&&(e.closable=!0),null==e.className&&(e.className=""),null==e.onShow&&(e.onShow=function(){}),null==e.onClose&&(e.onClose=function(){}),"boolean"!=typeof e.closable)throw new Error("Property `closable` must be a boolean");if("string"!=typeof e.className)throw new Error("Property `className` must be a string");if("function"!=typeof e.onShow)throw new Error("Property `onShow` must be a function");if("function"!=typeof e.onClose)throw new Error("Property `onClose` must be a function");return e}(t)),s=function(e){return!1!==t.onClose(a)&&function(e,t){return e.classList.remove("basicLightbox--visible"),setTimeout((function(){return!1===o(e)||e.parentElement.removeChild(e),t()}),410),!0}(n,(function(){if("function"==typeof e)return e(a)}))};!0===t.closable&&n.addEventListener("click",(function(e){e.target===n&&s()}));var a={element:function(){return n},visible:function(){return o(n)},show:function(e){return!1!==t.onShow(a)&&function(e,t){return document.body.appendChild(e),setTimeout((function(){requestAnimationFrame((function(){return e.classList.add("basicLightbox--visible"),t()}))}),10),!0}(n,(function(){if("function"==typeof e)return e(a)}))},close:s};return a}},{}]},{},[1])(1);const Gl=Vl.create(document.querySelector("#html"),{onClose:()=>{f.body.style.overflow="visible"},onShow:()=>{f.body.style.overflow="hidden"}});function Xl(e){"Escape"===e.code&&Kl()}function Kl(){Gl.close(),window.removeEventListener("keydown",Xl)}f.form.addEventListener("submit",(function(e){e.preventDefault();const{email:t,password:n}=e.target.elements;console.log(Hl),"registration"===Hl?(Bl(t.value,n.value),Yl()):(Ul(t.value,n.value),g())})),f.formSwitchBtn.addEventListener("click",Yl),f.modalAuthEl.addEventListener("click",g),f.formSignInWithGoogle.addEventListener("click",(function(e){fi(Pl,Ll).then((e=>{Cn.credentialFromResult(e).accessToken;const t=e.user;g(),console.log(t)})).catch((e=>{e.code,e.message,e.customData.email,Cn.credentialFromError(e)}))})),f.galleryList.addEventListener("click",(function(e){e.preventDefault();const t=e.target.parentNode;if("A"!==t.nodeName&&"P"!==t.nodeName)return;const n=t.dataset.id;!async function(e){const t=JSON.parse(c),n=await t.results.filter((t=>t.id===e)),i=n[0];console.log(i),El(i),Gl.show(),$l(n),window.addEventListener("keydown",Xl)}(Number(n))})),f.btnCloseFilm.addEventListener("click",Kl),f.addToWatchedBtn.addEventListener("click",(function(e){const t=Ml(Tl,Il);console.log(t),Rl(t)&&Ol(e)&&Al(t),Al(t)})),f.addToQueueBtn.addEventListener("click",(function(e){const t=Ml(Tl,Il);Rl(t)&&Ol(e)&&Dl(t),Dl(t)})),f.buttonWrap.addEventListener("click",(async function(e){if("BUTTON"!==e.target.nodeName)return;u.param=e.target.dataset.id,u.page=1;const t=await u.getMovies();f.galleryList.innerHTML="";let n=t.total_pages;n>1e3&&(n=1e3),p(t.results),m.reset(n),function(){const e=f.buttonWrap.querySelector(".btn-accent");e&&e.classList.remove("btn-accent")}(),e.target.classList.add("btn-accent"),"popular"===u.param&&ql(!0,!1,!1),"top_rated"===u.param&&ql(!1,!0,!1),"now_playing"===u.param&&ql(!1,!1,!0)})),document.addEventListener("DOMContentLoaded",(async function(){try{const e=await u.getMovies(),t=e.results;let n=e.total_pages;n>1e3&&(n=1e3),p(t),m.reset(n)}catch(e){console.log(e.message)}})),m.on("afterMove",(async function(e){try{u.page=e.page;const{results:t}=await u.getMovies();f.galleryList.innerHTML="",p(t),window.scrollTo({top:230,behavior:"smooth"})}catch(e){console.log(e.message)}}));
//# sourceMappingURL=index.42f8f460.js.map
